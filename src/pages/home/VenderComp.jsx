...
import ProductosVentaDialog from '../../components/dialogs/ProductosVentaDialog';
...
const VenderComp = () => {
  const [datos, setDatos] = React.useState(localStorage.getItem('ventas') ? JSON.parse(localStorage.getItem('ventas')) : []);
